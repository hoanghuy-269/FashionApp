...
class ShopOrderManagement extends StatefulWidget {
  ...
  @override
  State<ShopOrderManagement> createState() => _ShopOrderManagementState();
}

class _ShopOrderManagementState extends State<ShopOrderManagement> with TickerProviderStateMixin {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [Tab(text: "Thu Ngân nhận "), Tab(text: "Khách hủy")],
        ),
      ),
